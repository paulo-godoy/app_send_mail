<?php
	...
	try {
	    ...
	    $mail->Username = 'pauloricardo.paulogodoy@gmail.com';                 // SMTP username
	    $mail->Password = 'ricardo80';                           // SMTP password
	    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
	    $mail->Port = 587;                                    // TCP port to connect to

	    //Recipients
	    $mail->setFrom('pauloricardo.paulogodoy@gmail.com', 'Paulo Godoy Remente');
			...
			<div class="row">
				<div class="col-md-12">
					...
					<? if($mensagem->status['codigo_status'] == 2) { ?>
						...
						<div class="container">
							<h1 class="display-4 text-danger">Mensagem não enviada!</h1>
							<p><?= $mensagem->status['descricao_status'] ?></p>
							<a href="index.php" class="btn btn-success btn-lg mt-5 text-white">Voltar</a>
						</div>
